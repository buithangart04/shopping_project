...
<html lang="en">
    ...
    <button class="btn btn-warning my-2 my-sm-0" type="submit">Search</button>
                ...
                <h3 class="h3"> Result for ${param.search} </h3>
                <c:if test="${sessionScope.error ==null}">
                    <% int i = 0;
                %>
                <c:forEach items="${sessionScope.listSearchpro}" var="p">
                    <%if (i % 4 == 0) { %>
                    <div class="row">
                        <%}%>
            ...
            <div class=" container paging">
                <ul>
                    ...
                    %>
                    <li class="pagination row"> <a href="search?search=${param.search}&start=<%=a%>&end=<%=b%>"><%=j%></a></li> 
                        <%
                            }
                        %>
